...
def lemmatize_text(text):
    ...
    lemmatized_tokens = [wnl.lemmatize(word, tg) if tg else word for word, tg in pos_tagged_text]
...
def normalize_corpus(corpus, lemmatize=True, 
    ...
    for index, text in enumerate(corpus):
        ...
        soup = BeautifulSoup(text, 'html.parser') # unescape characters will also be removed here
        text = soup.get_text()
